...
//creating a new array to save the numbers
const newArr = [];
//map over each element and parse string to integer + pusing into newArr
numbers.map((e) => {
